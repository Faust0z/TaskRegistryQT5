...
class TasksManager:
    def __init__(self):
        self.done_tasks = csv_manager.read_csv_done_tasks()
    ...
    def add_task(self, task_data):
        ...
        if csv_manager.write_csv_done_tasks(task_data):
    ...
    def delete_task(self, task_index):
        ...
        return csv_manager.rewrite_csv_done_tasks(self.done_tasks)


class TypesManager:
    def __init__(self):
        self.tasks_types = csv_manager.read_csv_tasks_types()
    ...
    def add_task_type(self, name, desc="No description") -> bool:
        ...
        if csv_manager.write_csv_tasks_types(new_task_type):
    ...
    def delete_task_type(self, name) -> bool:
        ...
        return csv_manager.rewrite_csv_done_tasks(self.tasks_types)
